...
model_save_path = "/N/u/mhaghir/Carbonate/CogIA_project/CIAIP/VAE/vae"
...
def create_dataset(filelist, N=195, M=1000): # N is 10000 episodes, M is number of timesteps
...
for epoch in range(NUM_EPOCH):
  ...
  for idx in range(num_batches):
    ...
    if ((train_step+1) % 5000 == 0):
      vae.save_json( model_save_path + "/vae_self_{}_zsize_2.json".format(NUM_EPOCH))
